...
add_filter('acf/load_value', 'wpaal_add_affiliate_links_acf');

function wpaal_add_affiliate_links_acf ($content) {
	if (get_option('aal_showacf')) return wpaal_add_affiliate_links($content);
	else return $content;
}
...
function wpaal_manage_affiliates() {
	...
	<div class="wrap">  
        ...
        <div id="aal_panel3">
            ...
            <form name="add-link" method="post" action="<?php echo admin_url( "admin-ajax.php");?>" id="aal_add_new_link_form">
                ...
                <span class="aal_label">Affiliate link:</span> <input class="aal_biginput" type="text" name="link" value="" id="aal_formlink" placeholder="https://" /> <br /><br />
	...
	if($apikey) {
		...
		$valid = file_get_contents('https://autoaffiliatelinks.com/api/apivalidate.php?apikey='. $apikey );
	...
	echo 'Your subscription to Wp Auto Affiliate Links PRO is expired. Please <a href="https://safecart.com/autoaffiliate/.aalmonth?apikey='. $apikey .'">renew your subscription</a> or <a href="https://autoaffiliatelinks.com/wp-auto-affiliate-links-pro/">create a new API key</a> <br /><br />';
	...
	echo 'The API key you entered is invalid. You have to <a href="https://autoaffiliatelinks.com/wp-login.php?action=register">register on our website</a> to get a valid API key. <br /><br />';
	...
	if(isset($valid->queries)) if($valid->queries == 'overquota') {
		...
		echo 'If you want links to be extracted and displayed automatically from Amazon, Clickbank, Shareasale, Ebay, Walmart, Commision Junction and Envato Marketplace you should consider activating PRO features. <a href="https://autoaffiliatelinks.com/wp-login.php?action=register">Get your API key.</a>';	
