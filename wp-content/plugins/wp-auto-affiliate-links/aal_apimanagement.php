        ...
        <div class="icon32" id="icon-options-general"></div>  
                ...
                <?php if($apikey) {
              	...
              	<h3>Request an API key:</h3><br /><br />
              	 <a href="https://autoaffiliatelinks.com/wp-login.php?action=register">Click here</a> to get your own API key.
                <br /><br />
...
?>    
	...
	echo 'Your subscription to Wp Auto Affiliate Links PRO is expired. Please <a href="https://safecart.com/autoaffiliate/.aalmonth?apikey='. $apikey .'">renew your subscription</a> or <a href="https://autoaffiliatelinks.com/wp-auto-affiliate-links-pro/">create a new API key</a>. You can go to your <a href="https://autoaffiliatelinks.com/members-area/download-page/">Download Page</a> on our website to check your subscription status. <br /><br />';
