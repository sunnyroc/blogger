...
function aal_admin_notice() {  
	...
	$aal_notice_dismissed = get_option('aal_option_dismissed57'); 
    ...
    <div id="aal_notice_div" class="updated">
     <div style="float: right;padding-top: 10px;"><a id="aal_dismiss_link" href="javascript:;" >Dismiss this notice</a></div>
      <p><?php   // _e( 'Amazon, Clickbank and Shareasale, Ebay, Walmart, Commission Junction, Bestbuy and Envato Marketplace  links can be automatically added into your content , you only have to <a href="http://autoaffiliatelinks.com/wp-login.php?action=register">get your API key</a>, add your affiliate ID and start earning. ', 'wp-auto-affiliate-links' ); 
		...
		_e( 'Amazon, Clickbank and Shareasale, Ebay, Walmart, Commission Junction, Bestbuy and Envato Marketplace  links can be automatically added into your content. Learn more about <a href="https://autoaffiliatelinks.com/wp-auto-affiliate-links-pro/">Auto Affiliate Links PRO</a>. ', 'wp-auto-affiliate-links' ); 
...
function aalDismissNotice() {
		...
		delete_option('aal_option_dismissed48');
		delete_option('aal_option_dismissed49');
		delete_option('aal_option_dismissed50');
		delete_option('aal_option_dismissed51');
		delete_option('aal_option_dismissed52');
		delete_option('aal_option_dismissed53');
		delete_option('aal_option_dismissed54');
		delete_option('aal_option_dismissed55');
		delete_option('aal_option_dismissed56');
		add_option('aal_option_dismissed57',true);
