...
function cyberchimps_slider_lite_page_options() {
    ...
    $page_fields	= array(
        ...
        array(
            ...
            'class'	=> '',
            'name'	=> __( 'Slide One Image', 'e-shopper' ),
        ...
        array(
            ...
            'class'	=> '',
            'name'	=> __( 'Slide One Link', 'e-shopper' ),
        ...
        array(
            ...
            'class'	=> '',
            'name'	=> __( 'Slide Two Image', 'e-shopper' ),
        ...
        array(
            ...
            'class'	=> '',
            'name'	=> __( 'Slide Two Link', 'e-shopper' ),
            'std'	=> esc_url( home_url() )
        ),
		array(
            'type'	=> 'single_image',
            ...
            'class'	=> '',
            'name'	=> __( 'Slide Three Image', 'e-shopper' ),
        ...
        array(
            ...
            'class'	=> '',
            'name'	=> __( 'Slide Three Link', 'e-shopper' ),
            'std'	=> esc_url( home_url() )
        )
    ...
    $page_config = array(
        ...
        'title'				=> __( 'Slider Lite Options', 'e-shopper' ), // meta box title
...
function cyberchimps_slider_lite_content() {
	...
	if( is_page() ) {
		...
		$slides[0]['img'] = cyberchimps_get_option('image_one_slide', get_template_directory_uri().apply_filters( 'cyberchimps_slider_lite_img1','/images/branding/slide1.jpg'));
		$slides[1]['img'] = cyberchimps_get_option( 'image_two_slide', get_template_directory_uri().apply_filters( 'cyberchimps_slider_lite_img2','/elements/lib/images/slider/slide1.jpg'));
		$slides[2]['img'] = cyberchimps_get_option( 'image_three_slide', get_template_directory_uri().apply_filters( 'cyberchimps_slider_lite_img3','/elements/lib/images/slider/slide1.jpg'));

		$slides[0]['link'] = cyberchimps_get_option('image_one_slide_url' , apply_filters('cyberchimps_slide_lite_url1' , ''));
		$slides[1]['link'] = cyberchimps_get_option( 'image_two_slide_url' , apply_filters('cyberchimps_slide_lite_url2' , ''));
		$slides[2]['link'] = cyberchimps_get_option( 'image_three_slide_url' , apply_filters('cyberchimps_slide_lite_url3' , ''));
	}
	$i = 0;
	?>
	<div class="row">
