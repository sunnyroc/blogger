...
if ( !class_exists( 'CyberChimpsParallax' ) ) {
	class CyberChimpsParallax {
		...
		public function cyberchimps_parallax_fields( $original ) {
			...
			$new_field[][3] = array(
				'name'    => __( 'Background image for parallax', 'e-shopper' ),
			...
			$new_field[][1] = array(
				...
				'desc'    => __( 'Set the background image at Appearance > Background to get parallax effect on whole body.', 'e-shopper' ),
				'type'    => 'toggle',
				'std'     => 1,
