...
function cyberchimps_portfolio_lite_page_options() {
	...
	$page_config = array(
		...
		'title'          => __( 'Portfolio Lite Options', 'e-shopper' ), // meta box title
...
function cyberchimps_portfolio_lite_content() {
	...
	// Getting options of portfolio-lite when added to blog
		...
		$img1 = cyberchimps_get_option('cyberchimps_blog_portfolio_lite_image_one', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_one' , '/cyberchimps/lib/images/portfolio.jpg'));
		$img2 = cyberchimps_get_option('cyberchimps_blog_portfolio_lite_image_two', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_two' , '/cyberchimps/lib/images/portfolio.jpg'));
		$img3 = cyberchimps_get_option('cyberchimps_blog_portfolio_lite_image_three', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_three' , '/cyberchimps/lib/images/portfolio.jpg'));
		$img4 = cyberchimps_get_option('cyberchimps_blog_portfolio_lite_image_four', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_four' , '/cyberchimps/lib/images/portfolio.jpg'));
		
		// Getting caption for each protfolio
		$caption1 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_lite_image_one_caption' , apply_filters('cyberchimps_portfolio_lite_image_one_caption' , ''));
		$caption2 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_lite_image_two_caption' , apply_filters('cyberchimps_portfolio_lite_image_two_caption' , ''));
		$caption3 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_lite_image_three_caption' , apply_filters('cyberchimps_portfolio_lite_image_three_caption' , ''));
		$caption4 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_lite_image_four_caption' ,  apply_filters('cyberchimps_portfolio_lite_image_four_caption' , ''));
		...
		// Getting URL of custom link
		$url1 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_link_url_one' , apply_filters('cyberchimps_portfolio_lite_url1' , ''));
		$url2 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_link_url_two' , apply_filters('cyberchimps_portfolio_lite_url2' , '') );
		$url3 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_link_url_three' , apply_filters('cyberchimps_portfolio_lite_url3' , ''));
		$url4 = cyberchimps_get_option( 'cyberchimps_blog_portfolio_link_url_four' , apply_filters('cyberchimps_portfolio_lite_url4' , ''));
	}
	...
	if( $url_toggle1 == 1 ) {
		$portfolio_link1 = esc_url($url1);
		$portfolio_rel1  = "";
	}
	else {
		$portfolio_link1 = esc_url($img1);
		$portfolio_rel1  = 'rel=cyberchimps-lightbox';
	}

	if( $url_toggle2 == 1 ) {
		$portfolio_link2 = esc_url($url2);
		$portfolio_rel2  = "";
	}
	else {
		$portfolio_link2 = esc_url($img2);
		$portfolio_rel2  = 'rel=cyberchimps-lightbox';
	}

	if( $url_toggle3 == 1 ) {
		$portfolio_link3 = esc_url($url3);
		$portfolio_rel3  = "";
	}
	else {
		$portfolio_link3 = esc_url($img3);
		$portfolio_rel3  = 'rel=cyberchimps-lightbox';
	}

	if( $url_toggle4 == 1 ) {
		$portfolio_link4 = esc_url($url4);
		$portfolio_rel4  = "";
	}
	else {
		$portfolio_link4 = esc_url($img4);
