...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h3 class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?><span class="glyphicon glyphicon-chevron-down"></span></h3>
	<div class="table-responsive">
		<section class="shipping-calculator-form">
	<table class="calculate-shipping-table">
		<tr>
			<td class="calc-shipping-td">
	...
	<tr>
		...
		<td class="calc-shipping-td">
			<button type="submit" name="calc_shipping" value="1" class="button update-totals"><?php _e( 'Update Totals', 'woocommerce' ); ?></button>
		</td>
	</tr>
</table>
