...
if( is_admin() ) {
	...
	$fields = array( array(
		...
		array(
			...
			'class'     => 'help-message',
			'name'      => __( 'Need Help?', 'e-shopper' ),
			'help_text' => '<a href="' . $pagedocs . '" target="_blank">' . sprintf( __( 'Visit the %s page options guide', 'e-shopper' ), $themenamefull ) . '</a></td>'
		)
	);
	/*
	...
	$config = array(
		...
		'title'          => __( 'Page Options', 'e-shopper' ), // meta box title
	...
	$slider_fields = array(
		array(
			...
			'class' => '',
			'name'  => __( 'Slider Image', 'e-shopper' ),
			'std'   => '',
		),
		array(
			'type'  => 'text',
			...
			'class' => '',
			'name'  => __( 'Slider Caption', 'e-shopper' )
		),
		array(
			'type'  => 'text',
			'id'    => 'cyberchimps_slider_url',
			'class' => '',
			'name'  => __( 'Custom Slide Link', 'e-shopper' )
		),
		array(
			'type'  => 'checkbox',
	...
	*/
	$slider_config = array(
		...
		'title'          => __( 'Custom Feature Slides', 'e-shopper' ), // meta box title
