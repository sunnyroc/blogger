...
function cyberchimps_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'e-shopper' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'e-shopper' ),
		'repeat-y'  => __( 'Repeat Vertically', 'e-shopper' ),
		'repeat'    => __( 'Repeat All', 'e-shopper' ),
	);
...
function cyberchimps_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'e-shopper' ),
		'top center'    => __( 'Top Center', 'e-shopper' ),
		'top right'     => __( 'Top Right', 'e-shopper' ),
		'center left'   => __( 'Middle Left', 'e-shopper' ),
		'center center' => __( 'Middle Center', 'e-shopper' ),
		'center right'  => __( 'Middle Right', 'e-shopper' ),
		'bottom left'   => __( 'Bottom Left', 'e-shopper' ),
		'bottom center' => __( 'Bottom Center', 'e-shopper' ),
		'bottom right'  => __( 'Bottom Right', 'e-shopper' )
	);
...
function cyberchimps_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'e-shopper' ),
		'fixed'  => __( 'Fixed in Place', 'e-shopper' )
	);
...
function cyberchimps_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'e-shopper' ),
		'italic'      => __( 'Italic', 'e-shopper' ),
		'bold'        => __( 'Bold', 'e-shopper' ),
		'bold italic' => __( 'Bold Italic', 'e-shopper' )
	);
