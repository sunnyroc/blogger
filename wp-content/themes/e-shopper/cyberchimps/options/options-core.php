...
function cyberchimps_add_core_headings( $headings_list ) {
	...
	$headings_list[] = array(
		...
		'title' => __( 'Help', 'e-shopper' ),
	);

	$headings_list[] = array(
		'id'    => 'cyberchimps_design_heading',
		'title' => __( 'Design', 'e-shopper' ),
	);

	$headings_list[] = array(
		'id'    => 'cyberchimps_header_heading',
		'title' => __( 'Header', 'e-shopper' ),
	);

	$headings_list[] = array(
		'id'    => 'cyberchimps_blog_heading',
		'title' => __( 'Blog', 'e-shopper' ),
	);

	$headings_list[] = array(
		'id'    => 'cyberchimps_templates_heading',
		'title' => __( 'Templates', 'e-shopper' ),
	);

	$headings_list[] = array(
		'id'    => 'cyberchimps_footer_heading',
		'title' => __( 'Footer', 'e-shopper' ),
	);
...
function cyberchimps_add_core_sections( $sections_list ) {
	...
	$sections_list[] = array(
		...
		'label'   => __( 'Layout Options', 'e-shopper' ),
	 ...
	 * 'label' => __('Background Options', 'e-shopper' ),
	 * 'heading' => 'cyberchimps_design_heading'
	 * );
	 */
	...
	$sections_list[] = array(
		...
		'label'   => __( 'Custom Colors', 'e-shopper' ),
		'heading' => 'cyberchimps_design_heading'
	);

	$sections_list[] = array(
		'id'      => 'cyberchimps_typography_section',
		'label'   => __( 'Typography', 'e-shopper' ),
		'heading' => 'cyberchimps_design_heading'
	);

	/*$sections_list[] = array(
		'id' => 'cyberchimps_custom_css_section',
		'label' => __('Custom CSS', 'e-shopper' ),
		'heading' => 'cyberchimps_design_heading'
	);
...
/**************************** HEADER **************************************************/
	...
	$sections_list[] = array(
		...
		'label'   => __( 'Header Drag &#38; Drop', 'e-shopper' ),
		'heading' => 'cyberchimps_header_heading'
	);

	$sections_list[] = array(
		'id'      => 'cyberchimps_header_options_section',
		'label'   => __( 'Header Options', 'e-shopper' ),
		'heading' => 'cyberchimps_header_heading'
	);

	$sections_list[] = array(
		'id'      => 'cyberchimps_header_social_section',
		'label'   => __( 'Social Icons', 'e-shopper' ),
		'heading' => 'cyberchimps_header_heading'
	);
	...
	$sections_list[] = array(
		...
		'label'   => __( 'Drag & Drop', 'e-shopper' ),
		'heading' => 'cyberchimps_blog_heading'
	);

	$sections_list[] = array(
		'id'      => 'cyberchimps_blog_options_section',
		'label'   => __( 'Blog Options', 'e-shopper' ),
		'heading' => 'cyberchimps_blog_heading'
	);
...
//check if free theme	
	if ( $theme_check == 'free' ):
		$sections_list[] = array(
			...
			'label'   => __( 'Blog Slider Lite', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);

		$sections_list[] = array(
			'id'      => 'cyberchimps_blog_portfolio_lite_section',
			'label'   => __( 'Portfolio Lite Options', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);

		$sections_list[] = array(
			'id'      => 'cyberchimps_blog_boxes_lite_section',
			'label'   => __( 'Boxes Lite', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);
...
//check if pro theme
	if ( $theme_check == 'pro' ):
		$sections_list[] = array(
			...
			'label'   => __( 'Blog Slider', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);

		$sections_list[] = array(
			'id'      => 'cyberchimps_callout_section',
			'label'   => __( 'Callout Options', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);

		$sections_list[] = array(
			'id'      => 'cyberchimps_html_box_section',
			'label'   => __( 'HTML Box Options', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);

		$sections_list[] = array(
			'id'      => 'cyberchimps_carousel_section',
			'label'   => __( 'Carousel Options', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);

		$sections_list[] = array(
			'id'      => 'cyberchimps_portfolio_pro_section',
			'label'   => __( 'Portfolio Pro Options', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);

		$sections_list[] = array(
			'id'      => 'cyberchimps_recent_posts_section',
			'label'   => __( 'Recent Posts Options', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);
		$sections_list[] = array(
			'id'      => 'cyberchimps_separator_section',
			'label'   => __( 'Separator', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);
		$sections_list[] = array(
			'id'      => 'cyberchimps_blank_space_section',
			'label'   => __( 'Blank Space', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);
		$sections_list[] = array(
			'id'      => 'cyberchimps_google_maps_section',
			'label'   => __( 'Google Maps', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);
		$sections_list[] = array(
			'id'      => 'cyberchimps_video_section',
			'label'   => __( 'Video Options', 'e-shopper' ),
			'heading' => 'cyberchimps_blog_heading'
		);
	endif;
	...
	$sections_list[] = array(
		...
		'label'   => __( 'Boxes Options', 'e-shopper' ),
		'heading' => 'cyberchimps_blog_heading'
	);

	/*$sections_list[] = array(
		'id' => 'cyberchimps_featured_posts_section',
		'label' => __('Featured Posts Options', 'e-shopper' ),
		'heading' => 'cyberchimps_blog_heading'
	);*/

	/*$sections_list[] = array(
		'id'		=> 'cyberchimps_profile_section',
		'label'		=> __('Profile Options', 'e-shopper' ),
		'heading'	=> 'cyberchimps_blog_heading'
	);*/
	...
	$sections_list[] = array(
		...
		'label'   => __( 'Footer Options', 'e-shopper' ),
...
function cyberchimps_add_core_fields( $fields_list ) {
	...
	$pbe_array    = array(
		'author'     => __( 'Author', 'e-shopper' ),
		'categories' => __( 'Categories', 'e-shopper' ),
		'date'       => __( 'Date', 'e-shopper' ),
		'comments'   => __( 'Comments', 'e-shopper' ),
		'tags'       => __( 'Tags', 'e-shopper' )
	);
	...
	$fields_list[] = array(
		'name'    => apply_filters( 'cyberchimps_help_sub_heading', __( 'CyberChimps Help', 'e-shopper' ) ),
	...
	/* LAYOUT OPTIONS */
	$fields_list[] = array(
		'name'    => __( 'Responsive Design', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Responsive Videos', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Gallery Lightbox', 'e-shopper' ),
		'id'      => 'gallery_lightbox',
		'type'    => 'toggle',
		'std'     => 'checked',
		'section' => 'cyberchimps_custom_layout_section',
	...
	$fields_list[] = array(
		'name'    => __( 'Wide Sidebar', 'e-shopper' ),
		'id'      => 'wide_sidebar',
		'type'    => 'toggle',
		'std'     => apply_filters('cyberchimps_wide_sidebar_default',0),
		'desc'    => __( 'Only works on layouts with 1 sidebar', 'e-shopper' ),
		'section' => 'cyberchimps_custom_layout_section',
		'heading' => 'cyberchimps_design_heading'
	);

	$fields_list[] = array(
		'name'    => __( 'Max Width', 'e-shopper' ),
		'id'      => 'max_width',
		'class'   => '',
		'std'     => apply_filters('max_width_default','1020'),
		'desc'    => __( 'enter the width of your site in pixels', 'e-shopper' ),
		'type'    => 'text',
		'section' => 'cyberchimps_custom_layout_section',
		'heading' => 'cyberchimps_design_heading'
	);
	 ...
	 *
	 * $fields_list[] = array(
	 * 'name' => __('Select a background', 'e-shopper' ),
	 ...
	 *
	 * $fields_list[] = array(
	 * 'name' => __('Use a custom background', 'e-shopper' ),
	 ...
	 *
	 * $fields_list[] = array(
	 * 'name' => __('Background Image', 'e-shopper' ),
	 * 'desc' => __('Enter URL or upload file', 'e-shopper' ),
	 ...
	 *
	 * $fields_list[] = array(
	 * 'name' => __('Image position', 'e-shopper' ),
	 ...
	 *
	 * $fields_list[] = array(
	 * 'name' => __('Image repeat', 'e-shopper' ),
	 ...
	 *
	 * $fields_list[] = array(
	 * 'name' => __('Image attachment', 'e-shopper' ),
	 ...
	 * /* CUSTOM COLORS */
	$fields_list[] = array(
		'name'    => __( 'Select a Skin Color', 'e-shopper' ),
	...
	/** COMMENTED OUT - Using WP background customization
	 * $fields_list[] = array(
	 * 'name' => __('Background Color', 'e-shopper' ),
	 * 'desc' => __('Select background color', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Text Color', 'e-shopper' ),
		'desc'    => __( 'Select text color', 'e-shopper' ),
		'id'      => 'text_colorpicker',
		'std'     => '',
		'type'    => 'color',
		'section' => 'cyberchimps_custom_colors_section',
	...
	$fields_list[] = array(
		'name'    => __( 'Link Color', 'e-shopper' ),
		'desc'    => __( 'Select link color', 'e-shopper' ),
		'id'      => 'link_colorpicker',
		'std'     => '',
		'type'    => 'color',
		'section' => 'cyberchimps_custom_colors_section',
	...
	$fields_list[] = array(
		'name'    => __( 'Link Hover Color', 'e-shopper' ),
		'desc'    => __( 'Select link hover color', 'e-shopper' ),
	...
	$fields_list[] = array(
		...
		'name'    => __( 'Typography Options', 'e-shopper' ),
		'type'    => 'typography',
	...
	$fields_list[] = array(
		'name'    => __( 'Enter Google font', 'e-shopper' ),
		'id'      => 'google_font_field',
		'type'    => 'text',
		'std'     => apply_filters( 'cyberchimps_typography_google_default', '' ),
		'desc'    => __( 'Google font names are case sensitive', 'e-shopper' ),
		'section' => 'cyberchimps_typography_section',
		'heading' => 'cyberchimps_design_heading'
	);

	$fields_list[] = array(
		'name'    => __( 'Demo Text', 'e-shopper' ),
		'id'      => 'font_demo_text',
		'type'    => 'info',
	...
	$fields_list[] = array(
		'name'    => __( 'Font Family for headings', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Google font for headings', 'e-shopper' ),
	...
	$fields_list[] = array(
		...
		'name'     => __( 'Header Drag/Drop', 'e-shopper' ),
		'callback' => 'cyberchimps_drag_drop_field',
		'std'      => apply_filters( 'header_drag_and_drop_default', array(
			'cyberchimps_header_content' => __( 'Logo + Icons', 'e-shopper' )
		) ),
		'type'     => 'section_order',
		'options'  => apply_filters( 'header_drag_and_drop_options', array(
			'cyberchimps_header_content' => __( 'Logo + Icons', 'e-shopper' ),
			'cyberchimps_logo_search'    => __( 'Logo + Search', 'e-shopper' ),
			'cyberchimps_logo'           => __( 'Logo', 'e-shopper' )
		) ),
	...
	$fields_list[] = array(
		'name'    => __( 'Custom Logo URL', 'e-shopper' ),
		'id'      => 'custom_logo_url',
		'type'    => 'toggle',
	...
	$fields_list[] = array(
		'name'    => __( 'URL', 'e-shopper' ),
		'desc'    => __( 'Enter URL', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Custom Apple touch icon', 'e-shopper' ),
		'id'      => 'custom_apple',
		'type'    => 'toggle',
		'section' => 'cyberchimps_header_options_section',
		'heading' => 'cyberchimps_header_heading'
	...
	$fields_list[] = array(
		'name'    => __( 'Apple Touch URL', 'e-shopper' ),
		'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
	...
	if ( $theme_check == 'pro' ) {
		$fields_list[] = array(
			'id'      => 'google_analytics',
			'name'    => __( 'Google Analytics', 'e-shopper' ),
			'type'    => 'textarea',
			'desc'    => __( 'Copy and paste your Google Analytics code here', 'e-shopper' ),
			'section' => 'cyberchimps_header_options_section',
			'heading' => 'cyberchimps_header_heading'
		);
	}
	...
	if ( $theme_check == 'pro' ) {
		$fields_list[] = array(
			'id'      => 'header_scripts',
			'name'    => __( 'Header Scripts', 'e-shopper' ),
			'type'    => 'unfiltered_textarea',
			'desc'    => __( 'Please add script tags', 'e-shopper' ),
			'section' => 'cyberchimps_header_options_section',
			'heading' => 'cyberchimps_header_heading'
		);
	}
	...
	/********** SOCIAL STARTS ************/
	$fields_list[] = array(
		'name'    => __( 'Choose your icon style', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Facebook URL', 'e-shopper' ),
		'id'      => 'facebook_url',
	...
	$fields_list[] = array(
		'name'    => __( 'LinkedIn URL', 'e-shopper' ),
		'id'      => 'linkedin_url',
	...
	$fields_list[] = array(
		'name'    => __( 'Pinterest URL', 'e-shopper' ),
		'id'      => 'pinterest_url',
	...
	$fields_list[] = array(
		'name'    => __( 'Google Maps URL', 'e-shopper' ),
		'id'      => 'googlemaps_url',
	...
	$fields_list[] = array(
		'name'    => __( 'Email Address', 'e-shopper' ),
		'id'      => 'email_url',
	...
	$fields_list[] = array(
		'name'    => __( 'Instagram URL', 'e-shopper' ),
		'id'      => 'instagram_url',
	...
	$fields_list[] = array(
		...
		'name'     => __( 'Drag & Drop Blog Elements', 'e-shopper' ),
		'callback' => 'cyberchimps_drag_drop_field',
		'std'      => apply_filters( 'cyberchimps_elements_draganddrop_defaults', array(
			'slider_lite'    => __( 'Slider Lite', 'e-shopper' ),
			'boxes_lite'     => __( 'Boxes', 'e-shopper' ),
			'blog_post_page' => __( 'Post Page', 'e-shopper' )
		) ),
		'type'     => 'section_order',
		'options'  => apply_filters( 'cyberchimps_elements_draganddrop_options', array(
			'boxes_lite'         => __( 'Boxes', 'e-shopper' ),
			'portfolio_lite'     => __( 'Portfolio Lite', 'e-shopper' ),
			'blog_post_page'     => __( 'Post Page', 'e-shopper' ),
			'slider_lite'        => __( 'Slider Lite', 'e-shopper' )
		) ),
	...
	/********* BLOG OPTIONS STARTS ***********/
	$fields_list[] = array(
		'name'    => __( 'Select Page Layout', 'e-shopper' ),
		'id'      => 'sidebar_images',
	...
	$fields_list[] = array(
		'name'    => __( 'Blog Title Text', 'e-shopper' ),
		'id'      => 'blog_title_text',
	...
	$fields_list[] = array(
		'name'    => __( 'Post Formats Icons', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Post Excerpts', 'e-shopper' ),
		'id'      => 'post_excerpts',
		'type'    => 'toggle',
		'std'     => 0,
		'section' => 'cyberchimps_blog_options_section',
	...
	$fields_list[] = array(
		'name'    => __( 'Read More Text', 'e-shopper' ),
		'id'      => 'blog_read_more_text',
		'class'   => 'post_excerpts_toggle',
		'type'    => 'text',
		'std'     => __( 'Read More...', 'e-shopper' ),
		'section' => 'cyberchimps_blog_options_section',
		'heading' => 'cyberchimps_blog_heading'
	);

	$fields_list[] = array(
		'name'    => __( 'Excerpt Length', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Featured Images', 'e-shopper' ),
	...
	// Author
	$fields_list[] = array(
		'name'    => __( 'Post Byline Author', 'e-shopper' ),
	...
	// Categories
	$fields_list[] = array(
		'name'    => __( 'Post Byline Categories', 'e-shopper' ),
	...
	// Date
	$fields_list[] = array(
		'name'    => __( 'Post Byline Date', 'e-shopper' ),
		'id'      => 'post_byline_date',
		'std'     => 'checked',
		'type'    => 'toggle',
		'section' => 'cyberchimps_blog_options_section',
	...
	// Comments
	$fields_list[] = array(
		'name'    => __( 'Post Byline Comments', 'e-shopper' ),
	...
	// Tags
	$fields_list[] = array(
		'name'    => __( 'Post Byline Tags', 'e-shopper' ),
		'id'      => 'post_byline_tags',
		'std'     => 'checked',
		'type'    => 'toggle',
		'section' => 'cyberchimps_blog_options_section',
	...
	if ( $theme_check == 'free' ):
		...
		/********* BOXES LITE STARTS ****************/
		$fields_list[] = array(
			'name'    => __( 'Boxes Upgrade', 'e-shopper' ),
			'id'      => 'boxes_upgrade',
			'class'   => 'cyberchimps_pro_upgrade',
			'desc'    => sprintf( __( 'Boxes Lite limits you to a total of 3 boxes throughout your whole site. Upgrade to %1$s to be able to create as many boxes as you like. Categorize them and display each category on a different page.', 'e-shopper' ),
			                      '<a href="' . apply_filters( 'cyberchimps_upgrade_link', 'http://cyberchimps.com' ) . '" title="' . apply_filters( 'cyberchimps_upgrade_pro_title', __( 'Pro', 'e-shopper' ) ) . '">' . apply_filters( 'cyberchimps_upgrade_pro_title', __( 'Pro', 'e-shopper' ) ) . '</a>'
			),
			'type'    => 'info',
		...
		// Image uploader
		$fields_list[] = array(
			'name'    => __( 'First Box Image', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
		...
		// Box text
		$fields_list[] = array(
			'name'    => __( 'First Box Text', 'e-shopper' ),
		...
		// Image uploader
		$fields_list[] = array(
			'name'    => __( 'Second Box Image', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
		...
		// Box text
		$fields_list[] = array(
			'name'    => __( 'Second Box Text', 'e-shopper' ),
		...
		// Image uploader
		$fields_list[] = array(
			'name'    => __( 'Third Box Image', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
		...
		// Box text
		$fields_list[] = array(
			'name'    => __( 'Third Box Text', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Portfolio Upgrade', 'e-shopper' ),
			'id'      => 'portfolio_upgrade',
			'class'   => 'cyberchimps_pro_upgrade',
			'desc'    => sprintf( __( 'Portfolio Lite limits you to a total of 4 items throughout your whole site. Upgrade to %1$s to be able to create as many portfolio items as you like. Categorize them and display each category on a different page.', 'e-shopper' ),
			                      '<a href="' . apply_filters( 'cyberchimps_upgrade_link', 'http://cyberchimps.com' ) . '" title="' . apply_filters( 'cyberchimps_upgrade_pro_title', __( 'Pro', 'e-shopper' ) ) . '">' . apply_filters( 'cyberchimps_upgrade_pro_title', __( 'Pro', 'e-shopper' ) ) . '</a>'
			),
			'type'    => 'info',
		...
		// Image uploader
		$fields_list[] = array(
			'name'    => __( 'First Portfolio Image', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
		...
		// Image caption
		$fields_list[] = array(
			'name'    => __( 'First Portfolio Image Caption', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'First Porfolio Link', 'e-shopper' ),
		...
		// Image uploader
		$fields_list[] = array(
			'name'    => __( 'Second Portfolio Image', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
		...
		// Image caption
		$fields_list[] = array(
			'name'    => __( 'Second Portfolio Image Caption', 'e-shopper' ),
		...
		// Portfolio link toggle
		$fields_list[] = array(
			'name'    => __( 'Second Porfolio Link', 'e-shopper' ),
		...
		// Image uploader
		$fields_list[] = array(
			'name'    => __( 'Third Portfolio Image', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
		...
		// Image caption
		$fields_list[] = array(
			'name'    => __( 'Third Portfolio Image Caption', 'e-shopper' ),
		...
		// Portfolio link toggle
		$fields_list[] = array(
			'name'    => __( 'Third Porfolio Link', 'e-shopper' ),
		...
		// Image uploader
		$fields_list[] = array(
			'name'    => __( 'Fourth Portfolio Image', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
		...
		// Image caption
		$fields_list[] = array(
			'name'    => __( 'Fourth Portfolio Image Caption', 'e-shopper' ),
		...
		// Portfolio link toggle
		$fields_list[] = array(
			'name'    => __( 'Fourth Porfolio Link', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Portfolio Title', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Upgrade', 'e-shopper' ),
			'id'      => 'slider_upgrade',
			'class'   => 'cyberchimps_pro_upgrade',
			'desc'    => sprintf( __( 'Slider Lite limits you to a total of 3 images throughout your whole site. Upgrade to %1$s to be able to create more images. Categorize them and display each category on a different page.', 'e-shopper' ),
			                      '<a href="' . apply_filters( 'cyberchimps_upgrade_link', 'http://cyberchimps.com' ) . '" title="' . apply_filters( 'cyberchimps_upgrade_pro_title', __( 'Pro', 'e-shopper' ) ) . '">' . apply_filters( 'cyberchimps_upgrade_pro_title', __( 'Pro', 'e-shopper' ) ) . '</a>'
			),
			'type'    => 'info',
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Image 1', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
			'id'      => 'image_one_slide',
			'type'    => 'upload',
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Image 2', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
			'id'      => 'image_two_slide',
			'type'    => 'upload',
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Image 3', 'e-shopper' ),
			'desc'    => __( 'Enter URL or upload file', 'e-shopper' ),
...
//pro theme check
	if ( $theme_check == 'pro' ):
		...
		$fields_list[] = array(
			'name'    => __( 'Images per Row', 'e-shopper' ),
		...
		if ( $options_portfolio_cats ) {
			$fields_list[] = array(
				'name'    => __( 'Portfolio Category', 'e-shopper' ),
			...
			$fields_list[] = array(
				...
				'type'    => 'help',
				'desc'    => __( 'You need to create a Category', 'e-shopper' ),
				'section' => 'cyberchimps_portfolio_pro_section',
				'heading' => 'cyberchimps_blog_heading'
			);
		}
		...
		/********* BLOG SLIDER STARTS ***********/
		$fields_list[] = array(
			'name'    => __( 'Slider Size', 'e-shopper' ),
			'id'      => 'blog_slider_size',
			'type'    => 'select',
			'std'     => 'full',
			'options' => array(
				'full' => __( 'Full', 'e-shopper' ),
				'half' => __( 'Half', 'e-shopper' ),
			),
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Type', 'e-shopper' ),
			'id'      => 'blog_slider_type',
			'class'   => 'select-hide',
			'type'    => 'select',
			'std'     => 'custom_slides',
			'options' => array(
				'post'          => __( 'Posts', 'e-shopper' ),
				'custom_slides' => __( 'Custom', 'e-shopper' ),
			),
			'section' => 'cyberchimps_slider_section',
			'heading' => 'cyberchimps_blog_heading'
		);
		...
		$fields_list[] = array(
			'name'    => __( 'Post Categories', 'e-shopper' ),
		...
		if ( $options_slide_cats ) {
			$fields_list[] = array(
				'name'    => __( 'Custom Categories', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Number of Featured Blog Posts', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Height', 'e-shopper' ),
			'id'      => 'slider_height',
			'std'     => '',
			'type'    => 'text',
			'section' => 'cyberchimps_slider_section',
		...
		// Slider Speed 
		$fields_list[] = array(
			'name'    => __( 'Slider Speed ', 'e-shopper' ),
			'id'      => 'slider_speed',
			'std'     => '3000',
			'type'    => 'text',
			'section' => 'cyberchimps_slider_section',
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Arrows', 'e-shopper' ),
			'id'      => 'slider_arrows',
			'std'     => 'checked',
			'type'    => 'toggle',
			'section' => 'cyberchimps_slider_section',
		...
		$fields_list[] = array(
			'name'    => __( 'Callout Title', 'e-shopper' ),
			'id'      => 'callout_title',
			'std'     => sprintf( __( '%1$s\'s Call Out Element', 'e-shopper' ), apply_filters( 'cyberchimps_current_theme_name', 'CyberChimps' ) ),
			'type'    => 'text',
		...
		$fields_list[] = array(
			'name'    => __( 'Callout Text', 'e-shopper' ),
			'id'      => 'callout_text',
			'std'     => sprintf( __( 'Use %1$s\'s Call Out section on any page where you want to deliver an important message to your customer or client.', 'e-shopper' ), apply_filters( 'cyberchimps_current_theme_name', 'CyberChimps' ) ),
			'type'    => 'editor',
			'section' => 'cyberchimps_callout_section',
			'heading' => 'cyberchimps_blog_heading'
		);
		...
		$fields_list[] = array(
			'name'    => __( 'Callout Button', 'e-shopper' ),
			'id'      => 'callout_button',
			'std'     => '',
			'type'    => 'toggle',
			'section' => 'cyberchimps_callout_section',
		...
		$fields_list[] = array(
			'name'    => __( 'Callout Button Text', 'e-shopper' ),
			'id'      => 'callout_button_text',
			'class'   => 'callout_button_toggle',
			'std'     => __( 'Click Here', 'e-shopper' ),
			'type'    => 'text',
			'section' => 'cyberchimps_callout_section',
			'heading' => 'cyberchimps_blog_heading'
		);
		...
		$fields_list[] = array(
			'name'    => __( 'Callout Button URL', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Custom Callout Options', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Button Color', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Button Text Color', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'     => __( 'HTML Box', 'e-shopper' ),
			'id'       => 'html_box',
			'std'      => '',
			'desc'     => __( 'Enter your custom HTML code here', 'e-shopper' ),
			'type'     => 'editor',
		...
		$fields_list[] = array(
			'name'     => __( 'Separator', 'e-shopper' ),
			'id'       => 'separator_thickness',
			'std'      => apply_filters('separator_thickness_default','5'),
			'desc'     => __( 'Enter the thickness of horizontal separator here (in pixels)', 'e-shopper' ),
			'type'     => 'text',
			'section'  => 'cyberchimps_separator_section',
			'heading'  => 'cyberchimps_blog_heading'
		);
		$fields_list[] = array(
			'name'    => __( 'Color', 'e-shopper' ),
			'desc'    => __( 'Select color of the separator', 'e-shopper' ),
			'id'      => 'separator_color',
			'std'     => '',
			'type'    => 'color',
			'section' => 'cyberchimps_separator_section',
		...
		$fields_list[] = array(
			'name'    => __( 'Separator style', 'e-shopper' ),
			'desc'    => __( 'Select style of the separator', 'e-shopper' ),
			'id'      => 'separator_style',
			'std'     => '',
			'type'    => 'select',
			'options' => array(
		...
		$fields_list[] = array(
			'name'     => __( 'Blank Space', 'e-shopper' ),
			'id'       => 'blank_space',
			'std'      => apply_filters('blank_space_default','30'),
			'desc'     => __( 'Enter the height of blank space here', 'e-shopper' ),
			'type'     => 'text',
		...
		$fields_list[] = array(
			'name'     => __( 'Map embed iframe', 'e-shopper' ),
			...
			'desc'     => __( 'Go to <a target="_blank" href="https://www.google.com/maps">Google maps.</a> Steps to add: 1) Choose the location 2) Click on menu on top left corner and select "Share or embed map" 3) Select "Embed map" 4) Copy iframe code and paste here', 'e-shopper' ),
			'type'     => 'editor',
			'settings' => array( 'media_buttons' => true ),
			'section'  => 'cyberchimps_google_maps_section',
			'heading'  => 'cyberchimps_blog_heading'
		...
		$fields_list[] = array(
			'name'     => __( 'Video Title', 'e-shopper' ),
			'id'       => 'video_title',
			'std'      => apply_filters('video_title_default','Video title'),
			'desc'     => __( 'Enter the title here', 'e-shopper' ),
			'type'     => 'text',
			'section'  => 'cyberchimps_video_section',
			'heading'  => 'cyberchimps_blog_heading'
		);
		$fields_list[] = array(
			'name'     => __( 'Video Link', 'e-shopper' ),
			'id'       => 'video_link',
			'std'      => 'https://www.youtube.com/watch?v=O5yfVAx3LrM',
			'desc'     => __( 'Enter the video link here (youtube, vimeo)', 'e-shopper' ),
			'type'     => 'text',
			'section'  => 'cyberchimps_video_section',
			'heading'  => 'cyberchimps_blog_heading'
		);
		...
		$fields_list[] = array(
			'name'    => __( 'Custom Title', 'e-shopper' ),
		...
		if ( $options_carousel_cats ) {
			$fields_list[] = array(
				'name'    => __( 'Select a Category', 'e-shopper' ),
		...
		$fields_list[] = array(
			'name'    => __( 'Number of boxes per row', 'e-shopper' ),
			'id'      => 'boxes_per_row',
			'type'    => 'select',
			'options' => array(
				2 => '2',
	 ...
	 *
	 * $fields_list[]    = array(
	 * 'name'        => __('Profile Name', 'e-shopper' ),
	 * 'id'        => 'profile_name',
	 * 'type'        => 'text',
	 ...
	 *
	 * $fields_list[]    = array(
	 * 'name'        => __('Profile Picture', 'e-shopper' ),
	 * 'desc'        => __('Enter URL or upload picture', 'e-shopper' ),
	 * 'id'        => 'profile_picture',
	 * 'type'        => 'upload',
	 * 'std'        => $default_image,
	 * 'section'    => 'cyberchimps_profile_section',
	 ...
	 *
	 * $fields_list[]    = array(
	 * 'name'        => __('Phone Number', 'e-shopper' ),
	 * 'id'        => 'profile_phone',
	 * 'type'        => 'text',
	 * 'section'    => 'cyberchimps_profile_section',
	 * 'heading'    => 'cyberchimps_blog_heading'
	 ...
	 *
	 * $fields_list[]    = array(
	 * 'name'        => __('Website Address', 'e-shopper' ),
	 * 'id'        => 'profile_website',
	 * 'type'        => 'text',
	 * 'section'    => 'cyberchimps_profile_section',
	 * 'heading'    => 'cyberchimps_blog_heading'
	...
	/* SINGLE POSTS */
	$fields_list[] = array(
		'name'    => __( 'Sidebar Options', 'e-shopper' ),
		'desc'    => __( 'Images for layout.', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Post Format Icons', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Custom 404 Title', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'     => __( 'Custom 404 Content', 'e-shopper' ),
	...
	$fields_list[] = array(
		'name'    => __( 'Footer Widgets', 'e-shopper' ),
	...
	$fields_list[] = array(
		...
		'name'    => __( 'Footer Copyright Text', 'e-shopper' ),
