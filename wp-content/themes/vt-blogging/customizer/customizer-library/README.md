...
To see how this works in practice, please see the [Customizer Library Demo](https://github.com/devinsays/customizer-library) theme.
...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'vt-blogging' ), // Required
...
$panels[] = array(
	'id' => $panel,
	'title' => __( 'Panel Examples', 'vt-blogging' ),
	'priority' => '100'
);
...
$sections[] = array(
	'id' => $section,
	'title' => __( 'Panel Section', 'vt-blogging' ),
	'priority' => '10',
	'panel' => $panel
);
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-radio'] = array(
	'id' => 'example-radio',
	'label'   => __( 'Example Radio', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'radio',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-upload'] = array(
	'id' => 'example-upload',
	'label'   => __( 'Example Upload', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'upload',
	'default' => '',
);
...
$options['example-color'] = array(
	'id' => 'example-color',
	'label'   => __( 'Example Color', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'color',
	'default' => $color // hex
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'vt-blogging'),
);
~~~
...
$options['example-font'] = array(
	'id' => 'example-font',
	'label'   => __( 'Example Font', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'select',
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'vt-blogging' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
...
function vt_blogging_fonts() {
	...
	// Load Google Fonts
	wp_enqueue_style( 'vt_blogging_fonts', $font_uri, array(), null, 'screen' );

}
add_action( 'wp_enqueue_scripts', 'vt_blogging_fonts' );
~~~
