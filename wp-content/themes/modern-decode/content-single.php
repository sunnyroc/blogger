	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<footer class="entry-footer">
			...
			<div class="entry-meta">
				<p class="tags"><?php the_tags( __( 'Tagged as: ', 'modern-decode' ),', ' ); ?></p>
				<p class="categories"><?php esc_html_e( 'Categorized in&#58; ', 'modern-decode' ) . the_category( ', ' ); ?></p>
...
<?php else : ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<header class="entry-header">
			<?php
			if( get_theme_mod( 'show_featured_images_on_singles', true ) == true ):
		...
		<?php
		wp_link_pages( array(
			'before'      => '<div class="page-links">' . __( 'Pages:', 'modern-decode' ),
			'after'       => '</div>',
