...
<html <?php language_attributes(); ?>>
	<head>
		...
		<?php if ( get_background_image() ) {
			echo '<link rel="prefetch" href="' . get_background_image() . '">';
		} ?>
...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'modern-decode' ); ?></a>
<?php
function decode_create_sidebar_link() {
	if ( get_theme_mod( 'show_sidebar', true ) == true ) : ?>
		<button id="sidebar-link" class="sidebar-link SidebarLink <?php echo esc_attr( get_theme_mod( 'sidebar_button_position', 'left' ) ); ?>" title="<?php esc_attr_e( 'Show sidebar', 'modern-decode' ) ?>">
...
<?php if ( get_theme_mod( 'constant_sidebar', 'closing' ) == 'constant' && get_theme_mod( 'show_sidebar', true ) == true ) {
	echo '<div class="site-scroll">';
} ?>
	<header id="masthead" class="site-header" role="banner">
		<?php tha_header_top(); ?>
		<div class="site-branding">
			<?php do_action('modern_decode_create_header_image'); ?>
		...
		<?php
		if ( get_theme_mod( 'show_header_social_icons', false ) == true ) {
